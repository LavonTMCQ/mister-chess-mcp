import { SimpleChessAgent } from './simple-agent';
...
async function runAgents() {
  try {
    ...
    const mcpProcess = spawn('npm', ['run', 'mcp-simple'], {
      stdio: 'pipe',
      shell: true
    });
    ...
    // Create two agents
    const agent1 = new SimpleChessAgent('agent1');
    const agent2 = new SimpleChessAgent('agent2');
